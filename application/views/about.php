  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">E-shopindo adalah sebuah website yang menyediakan layanan jual atau beli barang.</p>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text-muted mb-4">Kamu dapat mencari sebuah barang yang kamu butuhkan di sini.</p><a href="<?= base_url('main'); ?>" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
  ...
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-lg-5">
        ...
        <p class="font-italic text-muted">tim yang terdiri dari beberapa anggota.</p>
      </div>
    </div>
