  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text mb-0">E-shopindo adalah sebuah website yang menyediakan layanan jual atau beli barang.</p>

        </p>
      </div>
      <div class="col-lg-6 d-none d-lg-block"><img src="<?= base_url('assets/img/profile/logoweb-gif.gif'); ?>" alt="" class="img-fluid"></div>
    </div>
  </div>
</div>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p class="font-italic text mb-4">Kamu dapat mencari sebuah barang yang kamu butuhkan di sini.</p><a href="<?= base_url('main'); ?>" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">Belanja mudah tanpa ribet</h2>
  ...
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-lg-5">
        ...
        <p class="font-italic text">tim yang terdiri dari beberapa anggota.</p>
      </div>
    </div>
    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/ahmad.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/adit.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/rizki.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/syauqi.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/ryan.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
      ...
      <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="rounded shadow-sm py-5 px-4"><img src="<?= base_url('assets/img/profile/agus.jpg'); ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
