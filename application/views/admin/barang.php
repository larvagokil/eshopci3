...
<div class="container-fluid">
    ...
    <div class="row-lg">
        <a href="#" class="btn btn-primary ml-auto" data-toggle="modal" data-target="#tambah-barg">[+] Tambah Barang</a>
        <div class="row-lg">
            <div class="col">
...
<!-- modal tambah -->
<div class="modal fade" id="tambah-barg" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
        ...
        <?= form_open_multipart('admin/tambah_brg');?>
        <div class="modal-body">
            <label for="nm">Nama Produk</label> <br>
            <input type="text" name="nm" id="nm" maxlength="100" class="form-control" autofocus required> <br>
            <label for="userfile" class="form-label">Gambar</label>
            ...
            <small>Maks ukuran gambar adalah 3MB!</small> <br>
            <label for="dkr">Deskripsi</label><br>
            <textarea name="dkr" id="dkri" class="form-control" rows="5" maxlength="5000" required></textarea><br>
            <script>
                CKEDITOR.replace( 'dkri' );
            </script> 
            <label for="hrg">Harga</label><br>
            <div class="input-group mb-3">
                <span class="input-group-text">Rp.</span>
