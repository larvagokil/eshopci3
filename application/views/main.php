  ...
  <body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav pl-3">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-sm btn-outline-success" href="">Masuk</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="">s</a>
            </li>
            <li class="nav-item">
              <a class="nav-link btn btn-sm btn-success text-light" href="">Daftar</a>
            </li>
        </ul>
        </div>
        ...
        <?php foreach ($brg as $b) { ?>
          ...
          <div class="card m-3 shadow" style="width: 14rem;float:left;">
            ...
            <div class="card-body" >
              ...
              <strong><p class="ms-2">Rp. <?= number_format($b->hrg_barang,2,",",".");?></p></strong>
